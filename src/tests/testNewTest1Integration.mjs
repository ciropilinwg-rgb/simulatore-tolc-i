...
section('Integrità Globale Banca 954 (con 65 da NEW Test1.pdf)');
check(questionBank.length === 954, `Totale quesiti esatto: 954 (trovati: ${questionBank.length})`);
...
check(invalidSubjects.length === 0, 'Tutti i 954 quesiti appartengono esclusivamente alle 4 materie ammesse');
...
check(subjectCounts['Comprensione verbale'] === 200, `Comprensione verbale fisica: 200 (80 base + 40 C1 + 40 C2 + 40 C3) (trovati: ${subjectCounts['Comprensione verbale']})`);
