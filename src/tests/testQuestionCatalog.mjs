...
check(rawQuestionBank.length === 417, 'La banca dati fisica contiene 417 record totali');
check(QUESTION_CATALOG_SUMMARY.totalCanonicalQuestions === 417, 'Il catalogo canonico contiene 417 domande');
check(QUESTION_CATALOG_SUMMARY.totalTolcPoolQuestions === 382, 'Il pool attivo TOLC-I contiene 382 quesiti');
