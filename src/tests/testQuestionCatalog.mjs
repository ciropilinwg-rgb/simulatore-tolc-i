...
check(rawQuestionBank.length === 392, 'La banca dati fisica contiene 392 record totali');
check(QUESTION_CATALOG_SUMMARY.totalCanonicalQuestions === 392, 'Il catalogo canonico contiene 392 domande');
check(QUESTION_CATALOG_SUMMARY.totalTolcPoolQuestions === 357, 'Il pool attivo TOLC-I contiene 357 quesiti');
