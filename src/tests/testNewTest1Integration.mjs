...
section('Integrità Globale Banca 914 (con 65 da NEW Test1.pdf)');
check(questionBank.length === 914, `Totale quesiti esatto: 914 (trovati: ${questionBank.length})`);
...
check(invalidSubjects.length === 0, 'Tutti i 914 quesiti appartengono esclusivamente alle 4 materie ammesse');
...
check(subjectCounts['Comprensione verbale'] === 160, `Comprensione verbale fisica: 160 (80 base + 40 C1 + 40 C2) (trovati: ${subjectCounts['Comprensione verbale']})`);
