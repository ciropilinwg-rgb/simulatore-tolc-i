...
section('Integrità Globale Banca 732 (con 65 da NEW Test1.pdf)');
check(questionBank.length === 732, `Totale quesiti esatto: 732 (trovati: ${questionBank.length})`);
...
check(invalidSubjects.length === 0, 'Tutti i 732 quesiti appartengono esclusivamente alle 4 materie ammesse');
...
check(subjectCounts['Logica'] === 149, `Logica fisica: 149 (49 base + 50 L1 + 50 L2) (trovati: ${subjectCounts['Logica']})`);
