...
section('Integrità Globale Banca 874 (con 65 da NEW Test1.pdf)');
check(questionBank.length === 874, `Totale quesiti esatto: 874 (trovati: ${questionBank.length})`);
...
check(invalidSubjects.length === 0, 'Tutti i 874 quesiti appartengono esclusivamente alle 4 materie ammesse');
...
check(subjectCounts['Comprensione verbale'] === 120, `Comprensione verbale fisica: 120 (80 base + 40 C1) (trovati: ${subjectCounts['Comprensione verbale']})`);
