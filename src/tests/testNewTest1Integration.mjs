...
section('Integrità Globale Banca 590 (con 65 da NEW Test1.pdf)');
check(questionBank.length === 590, `Totale quesiti esatto: 590 (trovati: ${questionBank.length})`);
...
check(invalidSubjects.length === 0, 'Tutti i 590 quesiti appartengono esclusivamente alle 4 materie ammesse');
...
check(subjectCounts['Scienze'] === 210, `Scienze fisica: 210 (70 base + 35 S1 + 35 S2 + 35 S3 + 35 S4) (trovati: ${subjectCounts['Scienze']})`);
