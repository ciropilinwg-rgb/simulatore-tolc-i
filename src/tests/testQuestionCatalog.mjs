...
check(rawQuestionBank.length === 1035, 'La banca dati fisica contiene 1035 record totali');
check(QUESTION_CATALOG_SUMMARY.totalCanonicalQuestions === 1035, 'Il catalogo canonico contiene 1035 domande');
check(QUESTION_CATALOG_SUMMARY.totalTolcPoolQuestions === 1000, 'Il pool attivo TOLC-I contiene 1000 quesiti');
