...
check(rawQuestionBank.length === 632, 'La banca dati fisica contiene 632 record totali');
check(QUESTION_CATALOG_SUMMARY.totalCanonicalQuestions === 632, 'Il catalogo canonico contiene 632 domande');
check(QUESTION_CATALOG_SUMMARY.totalTolcPoolQuestions === 597, 'Il pool attivo TOLC-I contiene 597 quesiti');
